  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        sector: "border-transparent bg-brand-green-100 text-brand-green-800",
        lga: "border-transparent bg-slate-100 text-slate-700",
        stage: "border-transparent bg-blue-100 text-blue-700",
