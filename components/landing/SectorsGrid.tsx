          ...
          {SECTORS.map((sector, i) => {
            ...
            return (
              <Link
                ...
                className="group bg-white rounded-2xl border border-neutral-100 p-5 hover:shadow-md hover:border-brand-green-100 transition-all duration-200 flex flex-col items-center text-center"
              >
                <div className={`h-12 w-12 rounded-xl flex items-center justify-center mb-3 ${colorClass} bg-opacity-60`}>
                  <Icon className="h-5 w-5" />
                </div>
                <span className="text-sm font-semibold text-neutral-800 group-hover:text-brand-green-700">
                  {sector.label}
                </span>
              </Link>
            );
